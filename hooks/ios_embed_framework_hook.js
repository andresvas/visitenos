...
module.exports = function (ctx) {
    ...
    proj.parseSync();
    addFramework("Component_iOS_Crypto_Implementation.framework",proj);
    addFramework("Component_iOS_Crypto_Interface.framework",proj);
    addFramework("Component_iOS_JOSE_Implementation.framework",proj);
    addFramework("Component_iOS_JOSE_Interface.framework",proj);
    addFramework("Component_iOS_Wallet_Domain_Implementation.framework",proj);
    addFramework("Component_iOS_Wallet_Domain_Interface.framework",proj);
    addFramework("Crypto.framework",proj);
    addFramework("JOSE.framework",proj);
    addFramework("Wallet.framework",proj);
