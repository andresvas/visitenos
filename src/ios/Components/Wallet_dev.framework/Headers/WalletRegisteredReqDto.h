...
@interface WalletRegisteredReqDto : NSObject
 ...
 *  @param dto provide wallet registered request data transfer object.
 *  @return web service request object.
 */
+ (id)mapDTOToRequest:(WalletRegisteredReqDto *)dto;
